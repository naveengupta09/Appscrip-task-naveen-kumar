...
export const metadata = {
  title: "Buy Premium Products Online | Appscrip Task",
  description:
    "Shop high-quality products at best prices. Fast delivery and secure checkout.",
};
          ...
          <div className="footer-contact">
            ...
            <div className="footer-block">
              ...
              <div className="footer-currency">
                ...
                >
                  <g clip-path="url(#clip0_88975_280)">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"

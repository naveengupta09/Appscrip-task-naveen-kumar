...
export const metadata = {
  title: "Buy Premium Products Online | Discover Our Collection",
  description:
    "Shop high-quality products including clothing, accessories, electronics and home essentials. Fast delivery, secure checkout, and quality guaranteed.",
  keywords: "online shopping, premium products, clothing, accessories, electronics, home essentials",
  openGraph: {
    title: "Discover Our Products | Premium Online Shopping",
    description: "Explore essentials crafted with care. Quality products for everyday use.",
    type: "website",
    locale: "en_US",
  },
  twitter: {
    ...
    description: "Shop high-quality products at best prices.",
  },
};
...
export default async function ProductsPage({
  ...
  const activeCategory = searchParams?.category
    ? formatCategory(searchParams.category)
    : "all";

  const activeTags = searchParams?.tags
    ? searchParams.tags.split(",").filter((tag) => tag.length > 0)
    : [];
  ...
  const availableTags = Array.from(
    new Set(
      normalizedProducts.flatMap((product) => product.tags || [])
    )
  ).sort();
    ...
    <div className="page">
      ...
      <main>
        <section className="hero container">
          ...
          <p>
            Explore essentials crafted with care. Each piece is designed to feel
            personal, practical, and refined for everyday use.
          </p>
        </section>
        ...
        <section className="catalog container" aria-label="Catalog">
          <CatalogClient
          ...
          <div className="footer-contact">
            ...
            <div className="footer-block">
              ...
              <div className="footer-currency">
                ...
                >
                  <g clipPath="url(#clip0_88975_280)">
                    <path
                    fillRule="evenodd"
                    clipRule="evenodd"
          ...
          <div className="footer-column">
            ...
            <div className="footer-social">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" className="social-icon">
                <img src="/icons/Insta.svg" alt="Instagram" width="20" height="20" />
              </a>
            ...
            <h3 className="footer-accepts">metta muse accepts</h3>
